...
//        editorView.isEditingEnabled = false  
        editorView.html = "<div>Hello hai&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HHHHH&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sdsdsd</div>"
...
//        editorView.selectRannge(word: "hai")
        editorView.replaceRhymeWord("HHHHH")
...
//        editorView.becomeFirstResponder()
    ...
    @IBAction func btn1(_ sender: UIButton) {
        editorView.replaceRhymeWord(sender.titleLabel?.text ?? "")
    }
